...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 2, "pointer");
 	...
 	ivoc_help("help ?1 Gfluct2 /home/kac2cf/M1_1000/M1Focus/components/mechanisms/modfiles/Gfluct.mod\n");
...
static int setRandObj(_threadargsproto_);
 ...
 static void _ba1(Node*_nd, double* _pp, Datum* _ppd, Datum* _thread, NrnThread* _nt)  {
  ...
  v = NODEV(_nd);
 noise_e = randGen ( _threadargs_ ) ;
   noise_i = randGen ( _threadargs_ ) ;
   }
...
#if NMODL_TEXT
static const char* nmodl_filename = "/home/kac2cf/M1_1000/M1Focus/components/mechanisms/modfiles/Gfluct.mod";
static const char* nmodl_file_text = 
